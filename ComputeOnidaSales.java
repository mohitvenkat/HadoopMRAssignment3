...
public class ComputeOnidaSales {
...
public static class MapperClass extends
 ...
 public void map(Longwritable key, Text value, Context context) 
		...
		if(companyNameNull && productNameNull && values[0].equalsIgnoreCase("Onida"){
			context.write(companyName.set(values[3]),new IntWritable(1));
		}
...
public static void main(String[] args) {
 ...
 try {
  Job job = Job.getInstance(conf, "ComputeOnidaSales");
  job.setJarByClass(ComputeOnidaSales.class);
